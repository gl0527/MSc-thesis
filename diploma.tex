...
% Main variables
%--------------------------------------------------------------------------------------
\newcommand{\vikszerzo}{Gurzó Lajos}
\newcommand{\vikkonzulens}{dr.~Umenhoffer Tamás}
\newcommand{\vikcim}{Általános célú, komponens alapú játékmotor fejlesztése}
\newcommand{\viktanszek}{Irányítástechnika és Informatika Tanszék}
\newcommand{\vikdoktipus}{Diplomaterv}
\newcommand{\vikdepartmentr}{Gurzó Lajos}
