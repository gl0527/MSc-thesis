...
%----------------------------------------------------------------------------
Ez a szakasz megvizsgálja diplomaterv keretében elkészített általános célú, komponens alapú
játékmotort annak használhatósága szempontjából. Ez egy olyan metrika, melyet nehéz mérni,
hiszen alapvetõen szubjektív véleményt tükröz. Valamiféle értékelésre mégis szükség van,
hiszen az elkészült rendszerem egyik legfontosabb minõsítése a használhatósága.
...
végeztem el és egy XML parser osztályt a DynamicMovementComponent osztály számára).

A dolgozat írásának idején a játéklogika oldali komponensek forrásfájlainak összmérete
1387 sor, s 11 ilyen komponenst definiáltam (nem mindet ismerettem az elõzõ fejezetben,
csak a legfontosabbakat). Ezekbõl az következik, hogy komponensenként körülbelül 126
sornyi kódot kellett írnom, ami véleményem szerint nem nevezhetõ soknak.

mennyire támaszkodnak az engine-re ezek a komponensek?
...
\caption{Kizárólag megjelenítéssel rendelkezõ játékobjektumoknál fellépõ képkockasebesség debugger
alól indított debug-os program esetében}
...
\caption{Kizárólag megjelenítéssel rendelkezõ játékobjektumoknál fellépõ képkockasebesség debugger
nélkül indított debug-os program esetében}
...
debugger alól indított debug-os program esetében}
...
\caption{Megjelenítéssel és dinamikus fizikával rendelkezõ játékobjektumoknál fellépõ képkockasebesség
debugger nélkül indított debug-os program esetében}
...
\begin{table}[ht]
	\footnotesize
	\centering
	\caption{A debugger alól futtatott debug-os programok futásainak eredményei.} \label{tab:MeasDevTableDesc}
	\begin{tabular}{ | l | c | c | c | c | }
	\hline
				& Natúr & Fizika & Animáció & Fényforrás \\ \hline
...
\begin{table}[ht]
	\footnotesize
	\centering
	\caption{A debugger nélkül futtatott debug-os programok futásainak eredményei.} \label{tab:MeasDevTableDesc}
	\begin{tabular}{ | l | c | c | c | c | }
	\hline
				& Natúr & Fizika & Animáció & Fényforrás \\ \hline
