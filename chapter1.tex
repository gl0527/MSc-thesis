...
\caption{Szakdolgozatom végeredménye}
...
%----------------------------------------------------------------------------
a többszörös örökléssel vigyázni kell, nehogy beleütközzünk a gyémánt problémába
...
composition over inheritance - kód újrafelhasználás és polimorfizmus leszármazás helyett kompozícióval
...
%----------------------------------------------------------------------------
\subsection{Felhasznált technológiák}\label{subsec:3rdparty}
%----------------------------------------------------------------------------
