...
\chapter{Bevezetõ}
%----------------------------------------------------------------------------
Ez a fejezet tömören összefoglalja a diplomaterv feladatkiírásának a lényegét, majd áttekinti a
dolgozatot megelõzõ munkákat, végezetül pedig a dolgozat szerkezetét ismerteti.
...
%----------------------------------------------------------------------------
C++-ban írt, platformfüggetlen, nyílt forráskódú, ingyenes XML feldolgozó\cite{TinyXML}.
