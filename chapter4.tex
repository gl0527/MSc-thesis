...
%----------------------------------------------------------------------------
A \sectref{Engine}. fejezetben leírtaknak megfelelõen nem csak a FiniteStateMachine osztály felhasználásával,
...
\caption{A játéklogika oldalon elkészített fontosabb komponensek leszármazás-hierarchiája}
...
\section{Tesztelés}
%----------------------------------------------------------------------------
Ebben a szakaszban az elkészített alkalmazás fõbb mozzanatait szemléltetem képernyõképek
segítségével.

A felhasználói felületet bemutató képernyõkép a \figref{MyGUI_Example} ábrán található.
...
A következõ képernyõkép egy ellenséges karakter megölését mutatja a \figref{DemoAppKill} ábrán.
...
A fegyver felvétele elõtti futás animációt a \figref{DemoAppUnarmedRun} ábra szemlélteti.
...
A felhasználó által irányított karakter halálanimációja a \figref{DemoAppDead} ábrán látható.
