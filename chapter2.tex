...
namespace-esites
%----------------------------------------------------------------------------
\section{Bemenetek kezelésének módosítása}
%----------------------------------------------------------------------------
...
%----------------------------------------------------------------------------
\section{Transzformációs komponens módosítása}
%----------------------------------------------------------------------------
<EZ A KOMPONENS A SZAKDOGAKOR MÉG NEM LÉTEZETT, AKKOR ÚJ KOMPONENSKÉNT KELLENE FELTÜNTETNI?>
