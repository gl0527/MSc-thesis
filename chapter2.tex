...
%----------------------------------------------------------------------------
Az automatizált build-elés a szoftverfejlesztés egyik fontos folyamata, melynek köszönhetõen az
alkalmazás elkészítését minden egyes alkalommal ugyanazokkal a lépésekkel, beállításokkal illetve
paraméterekkel lehet megtenni. A kódbázis növekedésével egyre nagyobb igény van az ilyen eszközök
használatára.

Egy ilyen eszköz a CMake is, ami egy olyan nyílt forrású rendszer, mely platform- és fordítófüggetlen
módon kezeli a futtatható állományok létrehozási folyamatait. A legtöbb platformfüggetlen rendszerrel
ellentétben a CMake nem kínál saját építési folyamatot, hanem az aktuális platform natív környezetét
...
%----------------------------------------------------------------------------
\section{Anyagjellemzõk leírása}
%----------------------------------------------------------------------------
...
segítségével könnyen olvasható formában lehet leírni a legkülönfélébb anyagoktulajdonságokat, illetve kényelmesen
...
alternatíva lehetett volna a DirectX is, de ennek használata akadályokba ütközött,
errõl részletesebben a \sectref{Engine} fejezetben írok.
